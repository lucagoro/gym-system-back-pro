Plataforma Integral de Gestión Sistema integral para la administración de gimnasios. Permite gestionar socios, controlar pagos, planes y visualizar estadísticas financieras.
...
- **Invitado:** `guestUser` / `guest1414` (Solo lectura)
  ...
  ## 🛠️ Stack Tecnológico
- **Frontend:** https://github.com/lucagoro/gym-system-front-pro.git (React, Tailwind CSS, Axios, Lucide Icons).
